  ...
  main: {
    ...
    main: {
      ...
      section: [{
        ...
        {
          markdown: Copy.text({
            en: `We shift among these functions to think, create, interact, and rest. Some tasks require setting one dimension aside to focus on another: math problems call for physical abstraction and rational execution; tough decisions benefit from emotional detachment; quick reflexes stem from rational disengagement. Other tasks are multidimensional: a dance performance draws on both physical and emotional focus; repairing a car demands physical execution and rational clarity; creative writing thrives between rational structure and emotional resonance.
